<?php 
    ...
    function get_password($login) {
		...
		try {
            $request = $pdo->prepare("SELECT `password` FROM `accounts` WHERE username='".$login."' OR email='".$login."' LIMIT 1");
            ...
            $bool = $request->execute();
                if ($bool) {
                    ...
                    echo "fail";
                    return 'error while requesting password';
                }
        ...
        <div class="w-full relative">
            ...
            <form class="mt-8" method="POST">
                ...
                <div class="py-2">
                    ...
                    <input required placeholder="" type="text" name="username"
                ...
                <div class="py-2" x-data="{ show: true }">
                    ...
                    <div class="relative">
                    <input required placeholder="" name="password" :type="show ? 'password' : 'text'" class="text-md block px-3 py-2 rounded-lg w-full 
                ...
                <div class="flex justify-between"><label class="block text-gray-500 font-bold my-4"><input type="checkbox"
                        ...
                        Password?</span></a></label></div> <button type="submit" name="login" class="mt-3 text-lg font-semibold 
                ...
                <span> No account yet ? <a class="text-blue-500" href="./signup.php">Create an Account</a></span>
            </form>
